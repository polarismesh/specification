...
type DiscoverDirection int32

const (
	DiscoverDirection_Callee DiscoverDirection = 0 //被调查询
	DiscoverDirection_Caller DiscoverDirection = 1 //主调查询
)

// Enum value maps for DiscoverDirection.
var (
	DiscoverDirection_name = map[int32]string{
		0: "Callee",
		1: "Caller",
	}
	DiscoverDirection_value = map[string]int32{
		"Callee": 0,
		"Caller": 1,
	}
)

func (x DiscoverDirection) Enum() *DiscoverDirection {
	p := new(DiscoverDirection)
	*p = x
	return p
}

func (x DiscoverDirection) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DiscoverDirection) Descriptor() protoreflect.EnumDescriptor {
	return file_request_proto_enumTypes[0].Descriptor()
}

func (DiscoverDirection) Type() protoreflect.EnumType {
	return &file_request_proto_enumTypes[0]
}

func (x DiscoverDirection) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DiscoverDirection.Descriptor instead.
func (DiscoverDirection) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	// 流量镜像规则
	DiscoverRequest_TRAFFIC_MIRRORING DiscoverRequest_DiscoverRequestType = 105
	// 故障注入规则
	DiscoverRequest_FAULT_INJECTION DiscoverRequest_DiscoverRequestType = 106
)
...
type DiscoverRequest struct {
	...
	Direction DiscoverDirection                   `protobuf:"varint,31,opt,name=Direction,proto3,enum=v1.DiscoverDirection" json:"Direction,omitempty"`
}
...
func (x *DiscoverRequest) GetDirection() DiscoverDirection {
	if x != nil {
		return x.Direction
	}
...
var file_request_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x22, 0x94, 0x04, 0x0a, 0x0f, 0x44, 0x69, 0x73, 0x63, 0x6f,
	...
	0x65, 0x72, 0x52, 0x06, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x33, 0x0a, 0x09, 0x44, 0x69,
	0x72, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x1f, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x15, 0x2e,
	0x76, 0x31, 0x2e, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x44, 0x69, 0x72, 0x65, 0x63,
	0x74, 0x69, 0x6f, 0x6e, 0x52, 0x09, 0x44, 0x69, 0x72, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22,
	0xb5, 0x02, 0x0a, 0x13, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75,
	...
	,
	...
	0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x42, 0x0c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x50,
...
var file_request_proto_goTypes = []interface{}{
	(DiscoverDirection)(0),                   // 0: v1.DiscoverDirection
	(DiscoverRequest_DiscoverRequestType)(0), // 1: v1.DiscoverRequest.DiscoverRequestType
	(*DiscoverFilter)(nil),                   // 2: v1.DiscoverFilter
	(*DiscoverRequest)(nil),                  // 3: v1.DiscoverRequest
	(*Service)(nil),                          // 4: v1.Service
}
var file_request_proto_depIdxs = []int32{
	1, // 0: v1.DiscoverRequest.type:type_name -> v1.DiscoverRequest.DiscoverRequestType
	4, // 1: v1.DiscoverRequest.service:type_name -> v1.Service
	2, // 2: v1.DiscoverRequest.Filter:type_name -> v1.DiscoverFilter
	0, // 3: v1.DiscoverRequest.Direction:type_name -> v1.DiscoverDirection
