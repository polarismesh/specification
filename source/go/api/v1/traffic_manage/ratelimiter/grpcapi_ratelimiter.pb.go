...
func init() {
	proto.RegisterFile("grpcapi_ratelimiter.proto", fileDescriptor_grpcapi_ratelimiter_765ebea45edf366a)
}

var fileDescriptor_grpcapi_ratelimiter_765ebea45edf366a = []byte{
